...
function print_favorite(arr_favorite) {
    ...
    for (let i = 0; i < arr_favorite.length; i++) {
        ...
        var div_delete_favorite = document.createElement("div");
        div_delete_favorite.className = "div_delete_favorite";
        favorite_food.appendChild(div_delete_favorite);
        ...
        button_delete_favorite.addEventListener('click', function () {

            delete_member((i));
        });
        div_delete_favorite.appendChild(button_delete_favorite);
    }
}
